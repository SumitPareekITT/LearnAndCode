...
public class OrderProcessor
{
    ...
    public OrderProcessor(IPaymentGateway paymentGateway, IInventoryService inventoryService, INotificationService notificationService)
    {
    ...
    public async Task<OrderResult> ProcessOrder(Order order)
    {
        ...
        try
        {
            ...
            return OrderResult.SuccessResult(paymentResult.TransactionId);
        }
        catch
        {
            await _inventoryService.ReleaseReservation(order.Items);
